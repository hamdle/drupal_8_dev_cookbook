 ...
 *   handlers = {
 *      "list_builder" = "Drupal\configentity\SiteAnnouncementListBuilder",
 *      "form" = {
 *        "default" = "Drupal\configentity\SiteAnnouncementForm",
 *        "add" = "Drupal\configentity\SiteAnnouncementForm",
 *        "edit" = "Drupal\configentity\SiteAnnouncementForm",
